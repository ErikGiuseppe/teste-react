...
export default function Footer() {
    ...
    const redirect = (Redirect: string) => {
        ...
        <footer className="bg-neutral-100 text-center text-neutral-600 dark:bg-neutral-600 dark:text-neutral-200 lg:text-left">
            <div
                ...
                <div className="flex justify-center">
                    ...
                    <a onClick={() => redirect('mailto:edilson@flagcon.com.br?subject=Olá, gostaria de falar com um atendente.')} className="mr-6 text-neutral-600 dark:text-neutral-200">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24"
                            fill="currentColor"
                    ...
                    <a onClick={() => redirect('https://www.instagram.com/flagcon.consorcios?igsh=MXNwZjgyZmxuZG85Yg==')} className="mr-6 text-neutral-600 dark:text-neutral-200">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="h-4 w-4"
                            fill="currentColor"
                    ...
                    <a onClick={() => redirect('https://www.linkedin.com/in/edilson-bandeira?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app')} className="mr-6 text-neutral-600 dark:text-neutral-200">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="h-4 w-4"
                            fill="currentColor"
            ...
            <div className="mx-6 py-10 text-center md:text-left">
                <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div className="">
                        ...
                        <p>
                            Flagcon, profissionais que irão te atender e entender as necessidades dos clientes , sendo referencias junto as Administradoras que representam nos segmentos de Imóveis e Automóveis.
                        </p>
                    </div>
                    {/* <!-- Products section --> */}
                    <div className="">
